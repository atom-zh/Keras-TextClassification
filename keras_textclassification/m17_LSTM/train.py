...
# 数据预处理, 删除文件目录下文件
from keras_textclassification.data_preprocess.text_preprocess import PreprocessTextMulti, delete_file, load_json, save_json, transform_multilabel_to_multihot, txt_write
from keras_textclassification.data_preprocess.utils import mkdir, draw_accuracy_figure, copy_file
# 模型图
...
def train(hyper_parameters=None, rate=1.0):
    ...
    copy_file(path_hyper_parameters, output_path + '/hyper_parameters.json')
